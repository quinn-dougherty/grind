""" This implementation is by John Dirk Morrison, posted here https://github.com/J-DM/Roth-Peranson

According to J-DM, the following implementation is based mostly on this splainer by the Canadian Resident Matching Service https://www.carms.ca/the-match/how-it-works/ , which is based on the following paper https://web.stanford.edu/~alroth/papers/rothperansonaer.PDF
"""
